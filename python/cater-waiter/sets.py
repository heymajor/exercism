...
def categorize_dish(dish_name, dish_ingredients):
    ...
    """
    dish = set(dish_ingredients)
    if dish.issubset(VEGAN):
        suffix = "VEGAN"
    elif dish.issubset(VEGETARIAN):
        suffix = "VEGETARIAN"
    elif dish.issubset(PALEO):
        suffix = "PALEO"
    elif dish.issubset(OMNIVORE):
        suffix = "OMNIVORE"
    elif dish.issubset(KETO):
        suffix = "KETO"

    return f"{dish_name}: {suffix}"
...
def tag_special_ingredients(dish):
    ...
    special = set(ingredients).intersection(SPECIAL_INGREDIENTS)
